...
const per_stat_error = validate_ev_spread({ hp: 253, atk: 0, def: 0, spa: 0, spd: 0, spe: 0 });
assert(per_stat_error !== null && per_stat_error.includes("hp") && per_stat_error.includes("0 and 252"), "253 EV must fail");

const total_error = validate_ev_spread({ hp: 252, atk: 252, def: 5, spa: 0, spd: 0, spe: 0 });
