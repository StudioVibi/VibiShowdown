...
var roster = [
  ...
  },
  {
    ...
    name: "Croni",
    role: "Mystic",
    stats: { level: 10, maxHp: 36, attack: 15, defense: 8, speed: 14 },
    possibleMoves: MOVE_OPTIONS,
    possiblePassives: PASSIVE_OPTIONS,
  ...
  },
  {
    ...
    name: "Harpy",
    role: "Striker",
    stats: { level: 10, maxHp: 34, attack: 18, defense: 7, speed: 16 },
    possibleMoves: MOVE_OPTIONS,
    possiblePassives: PASSIVE_OPTIONS,
    defaultMoves: ["basic_attack", "protect", "none", "none"],
    defaultPassive: "none"
  },
  {
    ...
    name: "Hoof",
    role: "Tank",
    stats: { level: 10, maxHp: 60, attack: 14, defense: 10, speed: 6 },
    possibleMoves: MOVE_OPTIONS,
    possiblePassives: PASSIVE_OPTIONS,
    defaultMoves: ["basic_attack", "protect", "none", "none"],
    defaultPassive: "regen_5pct"
  },
  {
    ...
    name: "Knight",
    role: "Guardian",
    stats: { level: 10, maxHp: 50, attack: 17, defense: 10, speed: 8 },
    possibleMoves: MOVE_OPTIONS,
    possiblePassives: PASSIVE_OPTIONS,
    defaultMoves: ["basic_attack", "protect", "none", "none"],
    defaultPassive: "none"
  ...
  },
  {
    ...
    name: "Priestess",
    role: "Support",
    stats: { level: 10, maxHp: 38, attack: 15, defense: 10, speed: 11 },
    possibleMoves: MOVE_OPTIONS,
    possiblePassives: PASSIVE_OPTIONS,
    defaultMoves: ["basic_attack", "none", "none", "none"],
    defaultPassive: "regen_5pct"
