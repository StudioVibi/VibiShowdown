...
const MOVE_TOOLTIP_DESCRIPTIONS: Record<string, string> = {
  ...
  sekyps:
    "Aplica o debuff Sekyps: no ending_turn causa dano flat 24 por stack (24/48/72/...), stacka ao reaplicar, nao remove no switch, nao causa dano no turno em que e usado e nao causa dano no turno em que o alvo troca.",
