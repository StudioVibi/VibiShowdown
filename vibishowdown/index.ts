...
const MOVE_TOOLTIP_DESCRIPTIONS: Record<string, string> = {
  ...
  rejuvenation:
    "Cura 50% do dano sofrido no turno (se houver), ativa regen de +5% por turno e cada recast adiciona +5% no proximo turno ate o maximo de 15%.",
  ...
  sekyps:
    "Aplica o debuff Sekyps: no end_turn causa dano flat 24 por stack (24/48/72/...), stacka ao reaplicar, nao remove no switch, nao causa dano no turno em que e usado e nao causa dano no turno em que o alvo troca.",
